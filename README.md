...
```
For an unknown reason, the database wouldn't allow us to record the inventory report. You can't do anything about this unless you want to send a message to perkins.steve+codevid@gmail.com.# GamePartyManager\r\nHandles party guest registration, game creation, score reporting, and high score board
